        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              color: isDark ? null : AppTheme.lightPrimary.withValues(alpha: 0.1),
          ...
          Container(
            ...
            decoration: BoxDecoration(gradient: LinearGradient(colors: isDark ? [AppTheme.accentMustard.withValues(alpha: 0.2), AppTheme.accentRed.withValues(alpha: 0.1)] : [AppTheme.lightPrimary.withValues(alpha: 0.15), AppTheme.lightPrimary.withValues(alpha: 0.05)]), shape: BoxShape.circle),
            child: Text(controller.targetUser.email?[0].toUpperCase() ?? 'U', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? AppTheme.accentMustard : AppTheme.lightPrimary)),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(controller.targetUser.email ?? 'User', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.bold, color: isDark ? Colors.white : AppTheme.lightOnText), maxLines: 1, overflow: TextOverflow.ellipsis),
                Obx(() => Row(
                  children: [
                    Container(
                      width: 8, 
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(gradient: isDark ? LinearGradient(colors: [AppTheme.glowPurple.withValues(alpha: 0.2), AppTheme.deepPurpleLight.withValues(alpha: 0.1)]) : LinearGradient(colors: [AppTheme.lightPrimary.withValues(alpha: 0.1), AppTheme.lightPrimary.withValues(alpha: 0.05)]), shape: BoxShape.circle),
                child: Icon(Icons.chat_bubble_outline, size: 48, color: isDark ? AppTheme.accentMustard.withValues(alpha: 0.5) : AppTheme.lightPrimary.withValues(alpha: 0.4)),
              ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: isMe
              ...
              : LinearGradient(colors: isDark ? [AppTheme.accentMustard, AppTheme.accentRed] : [AppTheme.lightPrimary, AppTheme.lightSupport]),
          ...
          boxShadow: isMe ? null : [BoxShadow(color: (isDark ? AppTheme.accentMustard : AppTheme.lightPrimary).withValues(alpha: 0.3), blurRadius: 8, offset: const Offset(0, 3))],
          border: isMe ? Border.all(color: isDark ? AppTheme.glowPurple.withValues(alpha: 0.2) : Colors.grey.withValues(alpha: 0.1)) : null,
        ),
        child: Text(text, style: GoogleFonts.poppins(fontSize: 14, color: isMe ? (isDark ? Colors.white : AppTheme.lightOnText) : Colors.white)),
      ),
    );
  }
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              shape: BoxShape.circle,
              boxShadow: [BoxShadow(color: (isDark ? AppTheme.accentMustard : AppTheme.lightPrimary).withValues(alpha: 0.4), blurRadius: 12, offset: const Offset(0, 4))],
            ),
